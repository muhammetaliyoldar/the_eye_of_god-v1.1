...
def main():
    ...
    with sv.VideoSink(TARGET_VIDEO_PATH, video_info) as sink:
        for frame in frame_generator:
            ...
            green_light_indices = []
            try:
                green_light_indices = [i for i, c in enumerate(result.boxes.cls) if
                                       result.names[int(c)] == 'green-light']
            ...
            cv2.putText(legend, "Trafik Isigi Renk Kodlari:", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255),
                        1)
